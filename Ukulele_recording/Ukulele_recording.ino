...
#include "ADC3101.h"
//#include "gsc_model_fixed2.h" <- Removed in the recording!

#define I2S_SAMPLE_RATE 16000  // [16000, 48000] supported by the microphone
#define I2S_BITS_PER_SAMPLE 16 // I2S wordlength is 16

//Since we removed the model importing in this phase, we need to bring some constants and type definitions
#define MODEL_INPUT_SAMPLES 16000 
